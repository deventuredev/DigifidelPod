...
/// This class is the model for the token that is displayed on map.
SWIFT_CLASS("_TtC6Loooot8MapToken")
@interface MapToken : NSObject <GMUClusterItem>
...
SWIFT_CLASS("_TtC6Loooot15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(Loooot)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Loooot)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Loooot)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Loooot)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Loooot)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC6Loooot12TaskDelegate")
